...
<div id="OSC_Banner">
    ...
    <div class="clear"></div>
	  ...
	  <div id="VisitorInfo">
		当前访客身份：
				<?php echo $_SESSION['NAME']; ?>[ <a href="#">退出</a>] <span id="OSC_Notification">
    ...
    <div id="lnks">
		...
		<div>
			<a href="user/index_logined">TA的博客列表</a>&nbsp;|
...
<div class="Blog">
  ...
  <div class="BlogTitle">
    ...
    <div class="BlogStat">
			...
			<a href="newBlog.htm">编辑</a>&nbsp;|&nbsp;<a href="javascript:delete_blog(24026)">删除</a>
				...
				<?php echo $_SESSION['NAME']; ?>发表于1小时前 , 
  ...
  <div class="BlogContent TextContent">
	...
	<ul id="BlogComments">
		...
		<li id="cmt_24026_154693_261665458">
			<div class="portrait">
				<a href="#"><img src="assets/images/portrait.gif" alt="sw0411" title="sw0411" class="SmallPortrait" user="154693" align="absmiddle">
				</a>			
			</div>
			<div class="body">
			<div class="title">
				<?php echo $_SESSION['NAME']; ?>发表于 <?php echo $val->ADD_TIME; ?>    			
        	     <a href="javascript:delete_c(24026,154693,261665458)">删除</a>
			</div>
		        <div class="post" "=""><p><?php echo $val->CONTENT; ?></p></div>
  ...
  <div class="CommentForm">
    <a name="postform"></a>
    <form id="form_comment" action="comment/add_comment?id=<?php echo $_GET['id']?>" method="POST">          
